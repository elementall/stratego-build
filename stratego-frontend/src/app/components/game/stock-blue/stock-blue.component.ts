...
@Component({
  selector: 'app-stock-blue',
  templateUrl: './stock-blue.component.html',
  styleUrls: ['./stock-blue.component.css']
})
export class StockBlueComponent implements OnInit {
  pieceClickStatus = false;
  pieces = this.gameService.bluePieces;
  gameState: GameState;
